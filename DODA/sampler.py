...
class eulerSampler(object):
    ...
    def sample_euler(self, shape, c, x=None, disable=None, s_churn=0., s_tmin=0., s_tmax=float('inf'), s_noise=1., unconditional_guidance_scale=1., unconditional_conditioning=None):
